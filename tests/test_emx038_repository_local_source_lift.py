...
class T(unittest.TestCase):
 ...
 def test_all_frozen_cells_executed(self):
  x=json.loads((P.parent/'remaining_matrix_results.json').read_text());self.assertEqual(x['executed_cell_count'],216);self.assertTrue(all(r['all_finite'] for r in x['results']))
